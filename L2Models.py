...
class IC_layer(nn.Module):
    ...
    def perform(self, source, target, Wd, Wh, Ww, Dd, Dh, Dw, data_term='l2'):
        """    
        Args:
        ...
        denum_1 = J11 + J22 + J33 + self.param
        # Update U
        Ud = (((J22 + J33 + self.param) * (Wd - Dd)) - (J12 * (Wh - Dh)) - (J13 * (Ww - Dw)) - J1t) / denum_1 + Dd
        Uh = (((J11 + J33 + self.param) * (Wh - Dh)) - (J12 * (Wd - Dd)) - (J23 * (Ww - Dw)) - J2t) / denum_1 + Dh
        Uw = (((J11 + J22 + self.param) * (Ww - Dw)) - (J13 * (Wd - Dd)) - (J23 * (Wh - Dh)) - J3t) / denum_1 + Dw
    ...
    def forward(self, image1,image2):
        ...
        for wp in range(self.cascade_warp):
            ...
            for k in range(wp*self.cascade_ic, (wp+1)*self.cascade_ic):
                ...
                ud, uh,uw = self.ic_blocks[k].perform(warped_image1, image2, vd, vh,vw, ud0, vh0, uw0, self.data_term)
